...
__global__ 
void softBitiableNodeOpti_kernel( const int nvar, const int ncheck, const int* sumX1, const int* n_mcv, const int* iind, const int * n_LLRin, 
...
__global__ 
void softBitiableNodeOpti2D_kernel( const int nvar, const int ncheck, const int* sumX1, const int* mcv, const int* iind, const int * LLRin, 
...
bool driverSoftBit::launch()
{
	...
	softBitiableNodeOpti2D_kernel<<< grid, block >>>( nvar, ncheck, 
	...
	softBitiableNodeOpti_kernel<<< grid, block >>>( nvar, ncheck, 
		d_sumX1, d_mcv, d_iind, d_input, 
		d_output, d_mvc, 
